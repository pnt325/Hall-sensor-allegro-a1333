...
#define PIN_A1333_CS (10)//analogInputToDigitalPin(PIN_A2))
...
class A1333 {
  ...
  public:
    ...
    uint16_t readEEPROM(uint16_t addr, uint32_t& value);
    uint16_t writeEEPROM(uint16_t addr, uint32_t value);
};
